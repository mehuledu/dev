...
var MasterComponent = (function () {
    function MasterComponent(sessionService, applicationRef, userService, blockUIService, router) {
        ...
        router.events.subscribe(function (uri) {
            applicationRef.zone.run(function () { return applicationRef.tick(); }); /// bug fix when hitting the back button in Internet Explorer  
        });
    }
...
MasterComponent = __decorate([
    core_1.Component({
        ...
        providers: [http_1.HTTP_PROVIDERS, user_service_1.UserService, customer_service_1.CustomerService, http_service_1.HttpService, blockui_service_1.BlockUIService]
    }),
